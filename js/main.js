...
var items = {
		...
		item011 : {
			...
			year_acquired: 2015,
			provenance: "indoors",
			creditline: "on permenant loan fron Virginia Museum of Fine Arts",
			colors: ["warm-faun", "goldenrod", "raw-umber", "sepia", "really-almost-black"],
			image: "objects/022.jpg"
		},

			item023 : {
			accession_number: "2015-00-023",
			title: "First Class USPS mailing label",
		 	creator: "man",
			department: "Ephemera",
			period: "Contemporary",
		 	medium: "ink on paper",
